...
EXCLUDE: frozenset[str] = frozenset(
    {
        ...
        # -- Grid / plan construction: sht_grid and sht_plan take a static
        #    band-limit and return the sampling points / transform plan (no array
        #    input to benchmark); the cataloged sht_forward / sht_inverse are the
        #    transforms that apply the plan. --------------------------------------
        'geometry.sht_grid',
        'geometry.sht_plan',
