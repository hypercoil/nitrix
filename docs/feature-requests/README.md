...
| 12.5 | [discrete-exterior-calculus](discrete-exterior-calculus.md) | `geometry.dec` | M | ✅ shipped (`mesh_gradient`/`mesh_curl`/`mesh_star_k`/`mesh_divergence`/`hodge_decompose`) |
...
| 12.9 | [spherical-harmonic-transform](spherical-harmonic-transform.md) | `geometry.harmonics` | M | ✅ shipped (`sht_forward`/`sht_inverse`/`sht_grid`/real-SH/DH-grid/`sht_rotation_matrix`) |
