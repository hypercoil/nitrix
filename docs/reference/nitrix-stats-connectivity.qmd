...
factorisation).  [`glasso_path`](nitrix-stats-connectivity/glasso_path.qmd) performs a warm-started $\lambda$
sweep and [`ebic_score`](nitrix-stats-connectivity/ebic_score.qmd) provides extended-BIC model selection (Foygel and
Drton, 2010).
...
[`glasso`](nitrix-stats-connectivity/glasso.qmd) consumes a `(p, p)` sample covariance `S` directly.
<!-- nitrix:/gen -->
...
.. [LW2004] Ledoit, O. and Wolf, M. (2004). A well-conditioned estimator for
   ...
   88(2), 365-411. `10.1016/S0047-259X(03)00096-4`
.. [Chen2010] Chen, Y., Wiesel, A., Eldar, Y. C. and Hero, A. O. (2010).
   ...
   Signal Processing*, 58(10), 5016-5029. `10.1109/TSP.2010.2053029`
