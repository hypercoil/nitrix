...
samples, so -- unlike [`CubicBSpline`](../nitrix-geometry-grid/CubicBSpline.qmd) -- it needs **no prefilter**.
...
Distinct from the other cubics: [`CubicBSpline`](../nitrix-geometry-grid/CubicBSpline.qmd) is *approximating*
...
[`Lanczos`](../nitrix-geometry-grid/Lanczos.qmd) is a windowed sinc.  Catmull-Rom is the cardinal cubic of
