...
[`MultiLabel`](../nitrix-geometry-grid/MultiLabel.qmd) ignores `cval`).  This is deliberate: a B-spline
...
[`CubicBSplineBoundaryWarning`](../nitrix-geometry/CubicBSplineBoundaryWarning.qmd) (the bare default
...
ignored and announced via [`CubicBSplineBoundaryWarning`](../nitrix-geometry/CubicBSplineBoundaryWarning.qmd).
