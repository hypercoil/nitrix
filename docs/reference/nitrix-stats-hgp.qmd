...
[`hgp_fit`](nitrix-stats-hgp/hgp_fit.qmd) fits, per element, a *hierarchical* GP smooth of a covariate
...
eigenbasis $\Phi$ (see [`nitrix.stats.gp.gp_fit`](nitrix-stats-gp/gp_fit.qmd)); the kernel enters
...
profiled by the same pooled-REML grid as [`nitrix.stats.gp.gp_fit`](nitrix-stats-gp/gp_fit.qmd).
...
The fit reuses the [`nitrix.stats.gp.gp_fit`](nitrix-stats-gp/gp_fit.qmd) HSGP eigenstructure and is
