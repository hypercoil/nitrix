...
Computed from the precision matrix (see [`precision`](../nitrix-stats-covariance/precision.qmd)) by
...
| `require_nonsingular` | `bool` | — | `True` | Forwarded to [`precision`](../nitrix-stats-covariance/precision.qmd): use a dense inverse (`True`, default) or the eigen-truncated pseudoinverse (`False`). |
| `**kwargs` | `Any` | — | `{}` | — |
